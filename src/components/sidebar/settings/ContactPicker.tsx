        ...
        <div className="flex flex-col px-4 pt-4 pb-3 border-b border-border/40 bg-muted/20 shrink-0">
          ...
          <div className="flex items-center justify-between px-1">
            ...
            <button
              onClick={() => {
                const allIds =
                  friends?.filter((f) => f !== null).map((f) => f.userId) || [];
            ...
            <div className="space-y-1">
              {[...(filteredFriends || [])]
                ...
                .map((friend) => {
                  ...
                  const isSelected = Array.from(selectedIds).includes(
                    friend.userId,
                  );
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className={`w-5 h-5 mr-1 rounded-full border-[1.5px] flex items-center justify-center transition-all duration-200
                      ...
                      >
                        {isSelected && (
                          <Check
                            size={12}
                            strokeWidth={3}
                            className="text-primary-foreground scale-in"
                          />
                        )}
                      </div>
                    </button>
