//src/components/profile/GlobalThemeCustomizer.tsx
...
export default function GlobalThemeCustomizer({
  onBack,
}: GlobalThemeCustomizerProps) {
  ...
  const currentPreset =
    userId && userConfigs[userId]
      ? userConfigs[userId].globalPreset
      : "default";
